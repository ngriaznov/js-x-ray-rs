...
pub const WARNINGS: &[(&str, &str, Severity, bool)] = &[
    (
        "parsing-error",
        "sast_warnings.parsing_error",
        Severity::Information,
        false,
    ),
    (
        "unsafe-import",
        "sast_warnings.unsafe_import",
        Severity::Warning,
        false,
    ),
    (
    ...
    (
        "unsafe-stmt",
        "sast_warnings.unsafe_stmt",
        Severity::Warning,
        false,
    ),
    (
        "encoded-literal",
        "sast_warnings.encoded_literal",
        Severity::Information,
        false,
    ),
    (
        "short-identifiers",
        "sast_warnings.short_identifiers",
        Severity::Warning,
        false,
    ),
    (
        "suspicious-literal",
        "sast_warnings.suspicious_literal",
        Severity::Warning,
        false,
    ),
    (
        "suspicious-file",
        "sast_warnings.suspicious_file",
        Severity::Critical,
        false,
    ),
    (
    ...
    (
        "unsafe-command",
        "sast_warnings.unsafe_command",
        Severity::Warning,
        true,
    ),
    (
        "synchronous-io",
        "sast_warnings.synchronous_io",
        Severity::Warning,
        true,
    ),
    (
    ...
    (
        "log-usage",
        "sast_warnings.log_usage",
        Severity::Information,
        false,
    ),
    (
        "sql-injection",
        "sast_warnings.sql_injection",
        Severity::Warning,
        false,
    ),
    (
        "monkey-patch",
        "sast_warnings.monkey_patch",
        Severity::Warning,
        false,
    ),
    (
        "insecure-random",
        "sast_warnings.insecure_random",
        Severity::Information,
        false,
    ),
    (
        "prototype-pollution",
        "sast_warnings.prototype_pollution",
        Severity::Warning,
        false,
    ),
    (
        "crypto.weak-scrypt",
        "sast_warnings.weak_scrypt",
        Severity::Warning,
        true,
    ),
    (
        "crypto.unsafe-prehash",
        "sast_warnings.unsafe_prehash",
        Severity::Warning,
        true,
    ),
    (
        "crypto.weak-bcrypt",
        "sast_warnings.weak_bcrypt",
        Severity::Warning,
        true,
    ),
    (
        "crypto.password-shucking",
        "sast_warnings.password_shucking",
        Severity::Warning,
        true,
    ),
    (
